        ...
        for (const device of obj.nodes.node) {
            ...
            if (enabled) {
                ...
                if (deviceTypeInfo !== null && deviceTypeInfo !== undefined) {
                    ...
                    this.logger(`Device ${device.name} with type: ${device.type} and nodedef: ${device.nodeDefId} is not specifically supported, returning generic device object: ${JSON.stringify(device)} `);
